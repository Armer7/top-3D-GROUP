...
/* harmony import */ var _module_menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/module/menu */ "./module/menu.js");


var menu = new _module_menu__WEBPACK_IMPORTED_MODULE_1__.Menu("#menu");
...
var Menu = /*#__PURE__*/function () {
  ...
  _createClass(Menu, [{
    ...
    value: function clickHandler(event) {
      try {
        var type = event.target.closest("[data-type]").dataset.type;
        var item = event.target.closest(".mobile-menu__list__item");

        if (type === "open-search" || type === "close-search") {
          this.hFirst.classList.toggle("showSearch");
        } else if (type === "menu-mobile" || type === "popup-menu") {
          this.$el.querySelector('[data-type="menu-mobile"]').classList.toggle("open-menu");
          this.$el.querySelector('[data-type="popup-menu"]').classList.toggle("show");
    ...
    key: "toggleChildren",
    value: function toggleChildren(item, selector) {
    ...
    value: function closeMenu() {
      var open = this.$el.querySelector(".is-open");

      if (open) {
        var parentLi = open.parentElement;
        var parenUl = parentLi.parentElement;
...
/******/ 	!function() {
/******/ 		__webpack_require__.h = function() { return "72e23bc98b00104f6094"; }
/******/ 	}();
/******/ 	
...
/******/ 		
/******/ 		var deferredModules = [
/******/ 			["./index.js","vendors-node_modules_core-js_modules_es_array_for-each_js-node_modules_core-js_modules_web_do-4d7324"]
/******/ 		];
